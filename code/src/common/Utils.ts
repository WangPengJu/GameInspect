...
export class Utils{
    ...
    public static getClassName(obj:any){
        ...
        if(obj.constructor  && obj.constructor["__classid"] && obj.constructor["__classid"].indexOf && obj.constructor["__classid"].indexOf("CLS_")!=0)return obj.constructor.__classid;
        ...
        if(obj.__className && obj.__className.substring(0, 4).toLocaleLowerCase()!="laya")return obj.__className;
        let clsName:string;
        if(obj.constructor && obj.constructor.name)clsName = obj.constructor.name;
        if(clsName && clsName.length>2)return clsName;
